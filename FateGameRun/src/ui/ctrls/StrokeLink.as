package ui.ctrls{
	...
	public class StrokeLink extends StrokeLabel{
		...
		public function StrokeLink(width:Number = 75, height:Number = 23){
			super(width, height);
			this.uiLabel = "描边链接";
		...
		protected function initLink():void{
			this.uiSubType		= UIInfo.STROKELINK;
		...
		override protected function fresh():void{
			...
			this.bgSprite.graphics.beginFill(0x000000, 0.1);
