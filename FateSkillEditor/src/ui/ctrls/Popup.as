package ui.ctrls
{
	...
	public class Popup extends JFrame
	{
		...
		public function Popup()
		{
			...
			title.gradBeg = Editor.FONT_COLOR;
			title.gradEnd = Editor.FF_COLOR;
		...
		{
			this.x = (Editor.stage.stageWidth-this.width)/2;
			this.y = (Editor.stage.stageHeight-this.height)/2;
			Editor.root.addChild(this);
		}
