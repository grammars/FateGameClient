package ui.ctrls.Advanced{
	...
	public class ComboScaleStateButton extends ComboScaleButton{
		...
		public function ComboScaleStateButton(width:Number=75, height:Number=23){
			super(width, height);
		...
		override protected function initButton():void{
			this.uiSubType = UIInfo.COMBO_SCALE_STATEBUTTON;
