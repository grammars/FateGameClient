package com.anstu.jui.build.template.info
{
	...
	public class TiScrollBarH extends TemplateInfo
	{
		...
		public function TiScrollBarH()
		{
			super();
			type = JuiType.JScrollBarH;
		}
		...
		override public function apply(ui:JComponent):void
		{
			...
			if(!scrollBar) { return; }
			var shell:CsScrollBar = new CsScrollBar(JuiConst.HORIZONTAL);
